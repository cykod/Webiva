...
namespace "cms" do 
    ...
    if(File.exists?(directory + "/storage.tar.gz"))
      ...
      DomainFile.update_all("server_id = #{Server.server_id}", 'file_type != "fld" and private = 0')
    end
    ...
    if(File.exists?(directory + "/private.tar.gz"))
      ...
      DomainFile.update_all("server_id = #{Server.server_id}", 'file_type != "fld" and private = 1')
    end
