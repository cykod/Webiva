  ...
  initialize: function(element, options) {
    ...
    this.el.observe(
      'keyup', function() {
        ...
        if($F(this).length != this.retrieveData('rt-value') &&  newsize < that.options.get('max')) {
...
var TextboxList = Class.create({
  ...
  makeResizable: function(li) {
    ...
    el.cacheData('resizable', new ResizableTextbox(el, Object.extend(this.options.get('resizable'),{min: 30, max: (this.element.getWidth()?this.element.getWidth():0)})));
    return this;
  },
...
var ProtoMultiSelectList = Class.create(TextboxList, {
