...
describe UserProfile::ManageController do
  ...
  reset_domain_tables :user_profile_types, :user_profile_entries, :content_types,  :content_publications, :end_users, :cms_controller_spec_tests, :user_profile_type_user_classes
  ...
  describe "viewing and editing" do
    ...
    it "should update a profile" do
      assert_difference "CmsControllerSpecTest.count", 1 do 
        post "view", :path => [ @user.id ], :tab => 1, :entry => { :string_field => 'Yay!' }
      end
