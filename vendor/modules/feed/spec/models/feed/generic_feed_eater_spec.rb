...
describe Feed::GenericFeedEater do
  ...
  it "should ouput a hash from xml" do
    ...
    Net::HTTP.should_receive(:get).once.and_return('<?xml version="1.0" encoding="UTF-8"?><items><item><name>Test</name><id>1</id></item><item><name>Test2</name><id>2</id></item></items>')
    @eater.parse
  ...
  it "should ouput a hash from json" do
    ...
    Net::HTTP.should_receive(:get).once.and_return('{"items":{"item":[{"name":"Test","id":"1"},{"name":"Test2","id":"2"}]}}')
    @eater.parse
