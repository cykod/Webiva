...
module Content
  ...
  class Content::Field
    ...
    @@setup_model_procs = {
      ...
      :required_array => Proc.new { |cls,fld| cls.validate { |mdl| mdl.errors.add(fld.model_field.field, 'is missing') if mdl.send(fld.model_field.field).reject(&:blank?).length == 0 } },
