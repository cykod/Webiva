...
module Content::ContentModelGenerator
  ...
  def content_model
    return @content_model_type if @content_model_type
    #return @@content_model_types[self.table_name] if @@content_model_types[self.table_name]
